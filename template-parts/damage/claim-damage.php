	...
	<div class="dashboard-page__order">
		<div class="dashboard-page__order-header">
			<div class="navbar-header">
				<h6 class="title"><?php echo esc_html__( 'Damage Claim', 'wilkeshub' ); ?></h6>
			</div>
								...
								<div class="cliam-collapse__body collapse" id="cliam-<?php echo intval( $order_id ); ?>">
									<div class="row">
												...
												<div class="cliam-simplebar" data-simplebar="init">
													...
													<div class="text">
														...
														<?php if ( $miscellaneous ) : ?>
															<h6 class="title"><?php echo esc_html__( 'Miscellaneous', 'wilkeshub' ); ?></h6>
										...
										<div class="col-xl-2 col-lg-12">
											<div class="cliam-collapse__body-action">
												<div class="cliam-simplebar" data-simplebar="init">
													<ul class="action-list list-unstyled">
														<li>
															<a href="#" class="btn btn-violet shop_claim_approved" data-postid="<?php echo get_the_ID(); ?>" data-nonce="<?php echo esc_attr( wp_create_nonce( 'shop_claim_approved_nonce' ) ); ?>">
																<?php echo esc_html__( 'Approve Claim', 'wilkeshub' ); ?>
															</a>
														</li>
													</ul>
												</div>
