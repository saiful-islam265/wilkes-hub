	...
	<div class="dashboard-page__order">
		<div class="dashboard-page__order-header">
			<div class="navbar-header" style="display: flex;">
				<h6 class="title">Floating Shelf Orders</h6>
				...
				<div class="order_change_bulk">
					<select class="form-control select_status" name="" id="">
						...
						<option value="Staged To Ship">Staged To Ship</option>
						<option value="Shipped">Shipped</option>
					</select>
				</div>
				<div class="bulk_action_btn_section">
					<button type="submit" class="btn btn-danger bulk_download_bol">Print Work Order</button>
				</div>
			</div>
		...
		<div class="dashboard-page__order-body" id="floating-shelves-order-list">
			...
			<div class="hub-pagination" id="floatingShelvesPaginate" data-max_num_pages="<?php echo $all_orders->max_num_pages; ?>">
				<?php
